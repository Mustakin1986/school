                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form method="post" action="{{ url('admin/teacher/add') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-11">
                                            ...
                                            <textarea type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter email"
                                                name="permanent_address" value="{{ old('permanent_address') }}"></textarea>
                                        </div>
                                        <div class="form-group col-md-11">
                                            <label for="exampleInputEmail1">Note</label>
                                            <textarea type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter email" name="note"
